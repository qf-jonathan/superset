...
import { SaveActionType, ExploreState } from 'src/explore/types';
  ...
  const actionHandlers: ActionHandlers = {
    ...
    [actions.UPDATE_FORM_DATA_BY_DATASOURCE]() {
      ...
      return {
        ...
        controls: getControlsState(
          newState as unknown as Parameters<typeof getControlsState>[0],
    ...
    [actions.SET_EXPLORE_CONTROLS]() {
      ...
      return {
        ...state,
        controls: getControlsState(
          state as unknown as Parameters<typeof getControlsState>[0],
    ...
    [HYDRATE_EXPLORE]() {
      ...
      // typedAction.data.explore is the plain ExploreState
      // It will be wrapped by redux-undo at a higher level in undoableExploreReducer
      return typedAction.data.explore as ExploreState;
    },
  };
